...
export const FORM_CONTROL =
  ...
  "border-slate-300 dark:border-[#2e2e2e] " +
  "text-slate-900 dark:text-slate-100 " +
  "placeholder:text-slate-400 dark:placeholder:text-slate-500 " +
  "hover:border-slate-400 dark:hover:border-[#3a3a3a] " +
...
export const FORM_ICON_BTN_MUTED =
  "flex-shrink-0 h-10 w-10 inline-flex items-center justify-center " +
  "rounded-md border border-slate-300 dark:border-[#2e2e2e] " +
  "text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-[#222222] transition-colors";
...
export const DATE_PICKER_SX = (theme) => ({
  "& .MuiPickersInputBase-root, & .MuiPickersOutlinedInput-root": {
    backgroundColor: theme.palette.mode === "dark" ? "rgba(34, 34, 34, 0.6)" : "#ffffff",
    borderRadius: "6px",
    height: "40px",
    fontSize: "0.875rem",
  },
  "& .MuiPickersOutlinedInput-notchedOutline": {
    borderColor: theme.palette.mode === "dark" ? "#2e2e2e" : "#cbd5e1",
  },
  "&:hover .MuiPickersOutlinedInput-notchedOutline": {
    borderColor: theme.palette.mode === "dark" ? "#3a3a3a" : "#94a3b8",
  },
