...
import { useBLPacks } from "../hooks/useBonLivraisons";
...
export const SelectBLPacksModal = ({ isOpen, onClose, onConfirm, alreadyInTable, t }) => {
  ...
  const { data: packsData, isLoading, isFetching } = useBLPacks({
