...
import { useBLProducts, useBLPacks } from "../hooks/useBonLivraisons";
...
/* ════════════════════════════════════════════════════════════════
   SelectBLItemsModal — unified articles + packs picker
   onConfirm(pendingProducts, pendingPacks, priceField)
════════════════════════════════════════════════════════════════ */
export const SelectBLItemsModal = ({
  isOpen,
  depotId,
  ...
  /* queries */
  const { data: productsData, isLoading: loadingProducts, isFetching } = useBLProducts({
    depotId,
  ...
  const { data: packsData, isLoading: loadingPacks, isFetching: fetchingPacks } = useBLPacks({
