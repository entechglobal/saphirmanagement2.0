...
import { useFournisseurSituation } from "../hooks/useSituation";
import { useRFFournisseurs } from "../../reglementfournisseur/hooks/useReglementFournisseur";
...
export const SituationFournisseurPage = () => {
  const { t } = useTranslation("situationFournisseur");
  ...
  const { data, isLoading, isFetching, isError } = useFournisseurSituation({
  ...
  return (
    <div className="space-y-4">
      ...
      <ReusableTable
        ...
        isError={isError}
        tableId="situation-fournisseur-table"
      />
    </div>
  );
};
